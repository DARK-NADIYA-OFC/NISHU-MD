...
cmd({
    ...
    async(Void, citel) => {
        let { data } = await axios.get('https://api.github.com/repos/manjulagagana/NISHU-MD')
        let cap = `Hey ${citel.pushName}\n
*⭐ Total Stars:* ${data.stargazers_count} stars
*🍽️ Forks:* ${data.forks_count} forks
*🍁 Repo:* https://github.com/manjulagagana/NISHU-MD
*Group:* https://chat.whatsapp.com
*public grp:* https://chat.whatsapp.com
*scan Qr:* https://blade-0wz6.onrender.com/
*youtube tt:* https://youtu.be
*Deploy Your Own:*-
...
if(!isCreator) return citel.reply(tlang().owner);
let str="*All available themes in NISHU MD*"
