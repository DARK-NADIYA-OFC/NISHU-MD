 ...
 * @project_name : NISHU-MD
 * @author : salmanytofficial <manjulagagana/NISHU-MD>
 * @description :darkchildofc1,A Multi-functional whatsapp bot.
 * @version 0.0.6
 **/
...
cmd({
    ...
    async(Void, citel, text) => {
        ...
        await Void.sendMessage(`${citel.sender}`, {
            image: log0,
            caption: `*Group Name: NISHU-Support*\n*Group Link:* https://Wa.me+94729039766`,
        });
