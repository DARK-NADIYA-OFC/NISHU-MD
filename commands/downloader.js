...
// citel.reply('name:-------'+info.video.title);
	...
	//data +="\n*Video Link     :* "+  vurl;
//citel.reply("    NISHU FACEBOOK DOWNLOADER  \n"+data)
//console.log(info);
	data +=Config.caption ;
                        let buttonMessage = {
                        video: {url:vurl},
...
try {
	...
	{ 
	        ...
	        let buttonMessage = 
		{
			...
			caption : "\t  *NISHU GOOGLE DRIVE DOWNLOADER*  \n" + data
		}
	        return await Void.sendMessage(citel.chat,buttonMessage, { quoted: citel })
	})
...
cmd({
        ...
        async(Void, citel, text) => {
	if (!text) return await citel.send('*Provide Repo Url, Ex:- _.gitclone https://github.com/manjulagagana/NISHU-MD_*') 
...
cmd({
		...
		let buttonMessage = {
                        ...
                        mimetype: 'video/mp4',
                        caption: "  •​🇳​​🇮​​🇸​​🇭​​🇺​ ​🇲​​🇩​-ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ• " + Config.caption ,
                    }
                 Void.sendMessage(citel.chat, buttonMessage, { quoted: citel })
            ...
            for (let i of search.all) {
				    ...
				    description: `*•​🇳​​🇮​​🇸​​🇭​​🇺​ ​🇲​​🇩​-ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ•* / ${i.timestamp}`
		    		   })
            }
            const sections = [{
...
cmd({
        ...
        async(Void, citel, text) => {
            let yts = require("secktor-pack");
            if (!text) return citel.reply(`Example : ${prefix}yts WhatsApp Bot by •​🇳​​🇮​​🇸​​🇭​​🇺​ ​🇲​​🇩​-ᴍᴜʟᴛɪᴅᴇᴠɪᴄᴇ•`);
            let search = await yts(text);
